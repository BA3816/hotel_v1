...
const VisitorRegister = () => {
    ...
    useEffect(() => {
        ...
        if (token) {
            navigate("/visitor/dashboard"); // redirect if already logged in
        }
    }, [navigate]);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            console.log("Making visitor registration request...");
            const response = await axiosClient.post("/api/visitor/register", {
                name: formData.name,
            ...
            console.log("✅ Visitor registration success:", response.data);
                ...
                <Card className="p-8 shadow-elegant border-border/50">
                    <div className="text-center mb-6">
                        ...
                        <p className="text-muted-foreground">
                            Register to access your booking details and status
                        </p>
                    </div>
